	...
	<div class="container">
		<div class="card-header my-3">
			<ul class="nav nav-tabs card-header-tabs">
				...
				<li class="nav-item"><a class="nav-link" href="daxay.jsp">Đá
						xay</a></li>
				<li class="nav-item"><a class="nav-link" href="nuocep.jsp">Nước
						ép</a></li>
				<li class="nav-item"><a class="nav-link" href="tra.jsp">Trà</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="trasua.jsp">Trà
						sữa</a></li>
				<li class="nav-item"><a class="nav-link active" href="#">Your
						Search</a></li>
			</ul>
		</div>
		<div class="row">
